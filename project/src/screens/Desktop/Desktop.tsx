...
export const Desktop = (): JSX.Element => {
  ...
  return (
    <div className="bg-white w-full min-w-[1440px] min-h-[4096px] flex flex-col">
      {/* Hero Section */}
      <section className="z-[3] w-[1440px] h-[1024px] relative bg-[url(/bg.svg)] bg-[#e1edf1]">
        {/* Profile Info */}
        <div className="absolute top-[512px] left-[1044px] w-[169px] h-[135px] flex flex-col items-center gap-2.5">
        ...
        {/* Profile Photo */}
        <div className="absolute top-[calc(50.00%_-_204px)] left-[calc(50.00%_+_313px)] w-[193px] h-[193px] flex bg-white rounded-[96.5px] shadow-[5px_5px_15px_#00000040]">
          <img
        ...
        {/* Skills Section */}
        <div className="absolute top-[486px] left-[163px] w-[448px] h-[277px]">
        ...
        {/* About Me Section */}
        <div className="absolute top-[175px] left-[163px] w-[644px] h-[230px] flex flex-col gap-3">
      ...
      {/* Navigation */}
      <nav className="flex z-[4] flex-col w-[1440px] h-[52px] items-center justify-center px-16 py-0 fixed top-0 left-0 bg-white">
      ...
      <section className="z-[2] w-[1440px] h-[1024px] relative bg-[#e1edf1]">
        <div className="absolute top-[54px] left-[121px] w-[1198px] h-[878px] flex gap-[74px]">
        ...
        <img
          className="absolute top-[129px] left-[428px] w-[233px] h-[216px]"
          alt="Vector"
          src="/vector-2.svg"
        />

        <img
          className="absolute top-[653px] left-[879px] w-[351px] h-[267px]"
          alt="Vector"
          src="/vector-1.svg"
        />

        <img
          className="absolute top-[467px] left-[121px] w-[518px] h-[465px] object-cover"
          alt="Card"
          src="/card-1.png"
        />
      </section>
      ...
      {/* Projects Section */}
      <section className="z-[1] w-[1440px] h-[2048px] relative bg-[#e1edf1]">
        <img
          className="absolute top-[243px] left-0 w-[1440px] h-[1486px]"
          alt="Projects"
          src="/projects.png"
        />
        ...
        <Card className="flex flex-col w-[550px] h-[390px] items-center justify-center gap-2.5 p-2.5 absolute top-[1492px] left-[245px] bg-white rounded-[35px] overflow-hidden shadow-[5px_5px_10px_#00000040] hover:shadow-xl transition-shadow cursor-pointer">
        ...
        <Card className="flex flex-col w-[550px] h-[390px] items-center justify-center gap-2.5 p-2.5 absolute top-[1063px] left-[671px] bg-white rounded-[35px] overflow-hidden shadow-[5px_5px_10px_#00000040] hover:shadow-xl transition-shadow cursor-pointer">
          <CardContent className="p-0 w-full h-full">
            <img
        ...
        <Card className="flex w-[550px] h-[390px] items-center gap-[49px] absolute top-[635px] left-[245px] bg-[#ffffff80] rounded-[35px] overflow-hidden shadow-[5px_5px_10px_#00000040] hover:shadow-xl transition-shadow cursor-pointer">
          <CardContent className="p-0 w-full h-full">
            <img
        ...
        <Card className="inline-flex items-center gap-[49px] absolute top-[168px] left-[245px] w-[989px] h-[382px] bg-[#ffffff80] rounded-[35px] shadow-[5px_5px_10px_#00000040] hover:shadow-xl transition-shadow cursor-pointer">
        ...
        <img
          className="absolute top-[1626px] left-[785px] w-[355px] h-[276px] object-cover"
          alt="Cat"
          src="/cat-1.png"
        />
      </section>
